...
<template>
	<div>
		...
		<div>
			...
			<Modal v-model="disableModel" ref="disableModel" title="商品下架/撤销">
				你确定要下架/撤销该商品吗 ?
				<div slot="footer">
			...
			<Modal v-model="editModel" ref="editModel" title="商品编辑">
				商品需下架后方可编辑, 是否继续查看商品详情?
				<div slot="footer">
					<Button type="text" @click="editcancel">取消</Button>
					<Button type="primary" @click="editProduct()">确定</Button>
				</div>
			</Modal>
